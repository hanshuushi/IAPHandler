#
#  Be sure to run `pod spec lint IAPHandler.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "IAPHandler"
  s.version      = "0.9.0"
  s.summary      = "In App Purcharse的轻量级使用框架"
  ...
  # Or just: s.author    = "Han Shuushi"
  # s.authors            = { "Han Shuushi" => "hanshuushi@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Han Shuushi"
